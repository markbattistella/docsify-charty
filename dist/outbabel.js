      ...
      switch (chartyType) {
        ...
        case 'area':
          ...
          for (var i = 1; i <= 10; i++) {
            ...
            areaDataHeaderLine.innerHTML += "<line x1=\"0\" x2=\"100\"\n\t\t\t\t\t\t\t\t\ty1=\"".concat(yPos, "\" y2=\"").concat(yPos, "\"\n\t\t\t\t\t\t\t\t\tstroke-width=\"0.2\"\n\t\t\t\t\t\t\t\t\tstroke-dasharray=\"4,4\"\n\t\t\t\t\t\t\t\t/>");
        ...
        case 'section':
          ...
          chartyJSONData.forEach(function (data, index) {
            ...
            if (chartyJSONOptionsLegend) {
              ...
              legend.innerHTML += "<label>\n\t\t\t\t\t\t\t\t\t<span style=\"background:".concat(chartyColours[index], ";\"></span>").concat(circleDataLabel, " ").concat(circleDataNumber, "</label>");
        ...
        case 'ring':
          ...
          chartyJSONData.forEach(function (data, index) {
            ...
            "".concat(2 * Math.PI * ringStrokeWidth, "\n\t\t\t\t\t\t\t\t ").concat(2 * Math.PI * ringStrokeWidth) // value
            );
            ringDataItemFG.setAttributeNS('charty', // namespace
            ...
            if (chartyJSONOptionsLegend) {
              ...
              legend.innerHTML += "<label>\n\t\t\t\t\t\t\t\t\t<span style=\"background:".concat(chartyColours[index], ";\"></span>").concat(ringDataLabel).concat(ringDataValue, "</label>");
            }
          });
          break;
        // charty-plot
        ...
        case 'bubble':
          ...
          for (var i = 1; i <= 10; i++) {
            ...
            plotDataHeaderLine.innerHTML += "<line x1=\"0\" x2=\"100\"\n\t\t\t\t\t\t\t\t\ty1=\"".concat(_yPos, "\" y2=\"").concat(_yPos, "\"\n\t\t\t\t\t\t\t\t\tstroke-width=\"0.2\"\n\t\t\t\t\t\t\t\t\tstroke-dasharray=\"4,4\"\n\t\t\t\t\t\t\t\t/>");
          ...
          chartyJSONData.forEach(function (data, index) {
            ...
            if (chartyJSONOptionsLegend) {
              // add the data
              legend.innerHTML += "<label>\n\t\t\t\t\t\t\t\t\t<span style=\"background:".concat(chartyColours[index], ";\"></span>").concat(data.label, "</label>");
            }
          });
          break;
        ...
        case 'column-stack':
          ...
          for (var i = 1; i <= 10; i++) {
            ...
            barDataHeaderLines.innerHTML += "<line\n\t\t\t\t\t\t\t\t\tx1=\"0\"\n\t\t\t\t\t\t\t\t\tx2=\"100\"\n\t\t\t\t\t\t\t\t\ty1=\"".concat(lineYPosition, "\"\n\t\t\t\t\t\t\t\t\ty2=\"").concat(lineYPosition, "\"\n\t\t\t\t\t\t\t\t\tstroke-width=\"0.2\"\n\t\t\t\t\t\t\t\t\tstroke-dasharray=\"4, 4\"\n\t\t\t\t\t\t\t\t/>"); // -- add: lines

            barDataHeaderLabel.innerHTML += "<text\n\t\t\t\t\t\t\t\t\tx=\"".concat(-5 + headerLabelOffset, "\"\n\t\t\t\t\t\t\t\t\ty=\"").concat(lineYPosition, "\">\n\t\t\t\t\t\t\t\t\t").concat(labelNumber, "\n\t\t\t\t\t\t\t\t</text>");
          ...
          chartyJSONData.forEach(function (data, index) {
            ...
            dataValue.forEach(function (item, i) {
              ...
              if (isStacked) {
                ...
                barDataItem.innerHTML += "\n\t\t\t\t\t\t\t\t\t\t<rect\n\t\t\t\t\t\t\t\t\t\t\twidth=\"".concat(widthOfColumn, "\"\n\t\t\t\t\t\t\t\t\t\t\theight=\"").concat(barDataItemPercent, "\"\n\t\t\t\t\t\t\t\t\t\t\tfill=\"").concat(chartyColours[index], "\"\n\t\t\t\t\t\t\t\t\t\t\tx=\"").concat(widthOfColumn * i, "\"\n\t\t\t\t\t\t\t\t\t\t\ty=\"").concat(barDataItemOffset, "\"\n\t\t\t\t\t\t\t\t\t\t/>\n\t\t\t\t\t\t\t\t\t"); // -- show values
                ...
                barDataItem.innerHTML += "\n\t\t\t\t\t\t\t\t\t<rect\n\t\t\t\t\t\t\t\t\t\twidth=\"".concat(sizeOfValue, "\"\n\t\t\t\t\t\t\t\t\t\theight=\"").concat(_barDataItemPercent, "\"\n\t\t\t\t\t\t\t\t\t\tfill=\"").concat(chartyColours[index], "\"\n\t\t\t\t\t\t\t\t\t\tx=\"").concat(sizeOfValue * index + widthOfColumn * i, "\"\n\t\t\t\t\t\t\t\t\t\ty=\"").concat(_barDataItemOffset, "\"\n\t\t\t\t\t\t\t\t\t/>\n\t\t\t\t\t\t\t\t\t"); // add in the footer label text

                barDataHeaderLabel.innerHTML += "<text\n\t\t\t\t\t\t\t\t\t\t\ty=\"".concat(105, "\"\n\t\t\t\t\t\t\t\t\t\t\tx=\"", sizeOfValue * index + widthOfColumn * i + sizeOfValueHalf, " \">\n\t\t\t\t\t\t\t\t\t\t\t").concat(data.label, "\n\t\t\t\t\t\t\t\t\t\t</text>"); // add in the hover text
                // -- show values
